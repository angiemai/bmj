	...
	var pageshow = function () {
	   ...
	   //		alert(vals);
		...
		showChart = function(vals){
		    vals = [11,16, 8, 7, 2, 25];  //, 3, 13.1, 4, 33.6, 5, 85.9, 6, 19.9];

		    var1 = [1, 6, 10, 17, 6, 20];  //, 3, 13.1, 4, 33.6, 5, 85.9, 6, 19.9];
		    var2 = [3, 3, -10, 3, 3, 3];  //1, 8, 2, 12, 3, 11, 4, 20, 5, 67, 6, 100];
		//    alert(vals);
		//    $.jqplot('plotChart', [vals, var1, var2]).replot({ clear: true, resetAxes: true });

		    $.jqplot('plotChart', [vals, var1, var2], {
